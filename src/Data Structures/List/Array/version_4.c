/*
List is a pointer to a structure containing a pointer to the first 
element of a dynamically allocated array and variable count.
...
typedef struct list {
    int *array, count; // Array with a size of MAX and a variable count
}* List; 
...
List initialize() {
    ...
    newList->array = (int *) malloc(sizeof(int) * MAX);
    newList->count = 0;
